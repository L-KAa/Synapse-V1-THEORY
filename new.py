...
if choice == "🏠 Home":
    ...
    **Built using Open Source Stack (Llama 3.2, BGE Embeddings, and Qdrant running locally within a Docker Container.)**
    ...
    - **Summarize**: Get concise summaries of the documents without hallucinations.
    - **Chat**: Interact with your documents through our intelligent chatbot.

    Enhance your health management experience with SYnapse! 😊
    """)

# Chatbot Page
elif choice == "🤖 Chatbot":
    st.title("🤖 SYnapse Chatbot Interface (Llama 3.2 RAG 🦙)")
    st.markdown("---")
...
# Footer
st.markdown("---")
st.markdown("© 2025 SYnapse. All rights reserved. 🛡️")
